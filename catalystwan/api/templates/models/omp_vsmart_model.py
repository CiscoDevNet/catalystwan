...
class OMPvSmart(FeatureTemplate, ConvertBoolToStringModel):
    ...
    graceful_restart_timer: Optional[int] = Field(default=None, json_schema_extra={'vmanage_key': 'graceful-restart-timer', 'data_path': ['timers']})
    eor_timer: Optional[int] = Field(default=None, json_schema_extra={'vmanage_key': 'eor-timer', 'data_path': ['timers']})
    holdtime: Optional[int] = Field(default=None, json_schema_extra={'vmanage_key': 'holdtime', 'data_path': ['timers']})
    affinity_group_preference: Optional[bool] = Field(default=None, json_schema_extra={'vmanage_key': 'affinity-group-preference'})
    advertisement_interval: Optional[int] = Field(default=None, json_schema_extra={'vmanage_key': 'advertisement-interval', 'data_path': ['timers']})
