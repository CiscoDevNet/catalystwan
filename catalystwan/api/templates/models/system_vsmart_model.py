...
class SystemVsmart(FeatureTemplate):
    ...
    admin_tech_on_failure: Optional[bool] = Field(default=True, json_schema_extra={'vmanage_key': 'admin-tech-on-failure'})
    iptables_enable: Optional[bool] = Field(default=True, json_schema_extra={'vmanage_key': 'iptables-enable'})
    track_default_gateway: Optional[bool] = Field(default=True, json_schema_extra={'vmanage_key': 'track-default-gateway'})
    dns_cache_timeout: Optional[int] = Field(default=2, ge=1, le=30, json_schema_extra={'vmanage_key': 'dns-cache-timeout'})
    track_transport: Optional[bool] = Field(default=True, json_schema_extra={'vmanage_key': 'track-transport'})
    controller_group_id: Optional[int] = Field(default=0, ge=0, le=100, json_schema_extra={'vmanage_key': 'controller-group-id'})
