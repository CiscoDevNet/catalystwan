...
class ServicesIp(BaseModel):
    ...
    http_server: Union[Variable, Global[bool], Default[Literal[False]]] = Field(
...
class GlobalParcel(_ParcelBase):
    ...
    services_ip: ServicesIp  # Key format is snake case in schema
