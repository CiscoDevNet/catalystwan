...
def run_demo(args: CmdArguments):
    ...
    with create_vManageSession(url=args.url, port=args.port, username=args.user, password=args.password) as session:
        ...
        from vmngclient.models.policy import ClassMapList
        ...
        from vmngclient.models.policy import LocalizedPolicy
        ...
        from vmngclient.models.policy import QoSMapPolicy
        ...
        from vmngclient.models.policy import RewritePolicy
        ...
        from vmngclient.models.policy import CentralizedPolicy, TrafficDataPolicy
        ...
        from vmngclient.models.policy import SiteList, VPNList
