...
from vmngclient.api.configuration_groups.parcel import Default, Parcel
...
class ManagementVPN(Parcel):
    ...
    ipv4_routes: Optional[List[WANIPv4StaticRoute]] = Field(
        default=[], alias="ipv4Route"
    )
    ipv6_routes: Optional[List[WANIPv6StaticRoute]] = Field(
        default=[], alias="ipv6Route"
    )
