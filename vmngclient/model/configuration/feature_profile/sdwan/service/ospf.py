...
class OspfInterfaceParametres(BaseModel):
    ...
    message_digest_key: Optional[Union[Global[int], Variable, DefaultWitoutValue]] = Field(
        alias="messageDigestKey", default=None
    )
    md5: Optional[Union[Global[str], Variable, DefaultWitoutValue]] = None
...
class OspfArea(BaseModel):
    ...
    area_type: Optional[Union[Global[AreaType], DefaultWitoutValue]] = Field(alias="aType", default=None)
...
class OspfData(BaseModel):
    ...
    metric: Optional[Union[Global[int], Variable, DefaultWitoutValue]] = None
    metric_type: Optional[Union[Global[MetricType], Variable, DefaultWitoutValue]] = Field(
        alias="metricType", default=None
    )
