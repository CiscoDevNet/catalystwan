...
class Device:
    ...
    memState: Optional[str] = field(default=None)
    cpuState: Optional[str] = field(default=None)
    cpuLoad: Optional[float] = field(default=None)
    stateDescription: Optional[str] = field(default=None, metadata={FIELD_NAME: "state_description"})
